...
export const metadata = {
  ...
  // ✅ Blog kartlarında öne çıkan görselin gelmesi için (senin sistemin bunu okuyor)
...
export default function LedTrends2026Page() {
  ...
  return (
    <>
      ...
      {/* --- HERO SECTION (Öne çıkan görsel = HERO) --- */}
            ...
            <div className="lg:w-2/3">
              <article className="prose prose-lg prose-headings:font-bold prose-headings:text-gray-900 prose-headings:scroll-mt-32 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-img:rounded-2xl max-w-none">
                ...
                <p>
                  ...
                  sürecinde yalnızca metrekare değil; piksel aralığı, sürücü kartı ve içerik uyumu gibi teknik detayları da doğru seçmek gerekir.
                </p>
                ...
                <p>
                  2026’da iç mekan sahnelerde <strong>P1.5 – P2.6</strong> aralığı yeni normal haline geldi. Bunun anlamı: aynı sahnede daha keskin metinler,
                  daha net grafikler ve kamera için TV kalitesinde görüntü.
                </p>

                <figure className="my-10 not-prose">
                  <Image
                    src={pixelPitchComparison}
                    alt="LED ekranlarda farklı piksel aralıklarını temsil eden genel görsel"
                  ...
                  />
                  <figcaption className="mt-3 text-sm text-gray-600 text-center font-medium">
                    Piksel aralığı küçüldükçe yazılar ve görseller daha yakından bile net görünür.
                  </figcaption>
                </figure>

                <h2 id="cob-led">2. COB LED 2.0 Nesli: Dayanıklılık ve Siyah Seviye</h2>
                <p>
                  COB panel yüzeyinde tüm çipler koruyucu bir tabaka ile kaplıdır. Bu sayede hem darbelere hem toza karşı çok daha dayanıklı bir yapı oluşur.
                </p>
                ...
                <figure className="my-10 not-prose">
                  ...
                  />
                  <figcaption className="mt-3 text-sm text-gray-600 text-center font-medium">
                    COB yüzey yapısı sahne kurulumunda hasar riskini azaltır; SMD ise outdoor kullanımda yaygındır.
                  </figcaption>
                </figure>

                <h2 id="hdr">3. HDR İçerik ve Renk Kalibrasyonu</h2>
                <p>
                  HDR destekli bir LED sistem, doğru içerik üretimi ve sahnede yapılan canlı kalibrasyon ile birleştiğinde algıyı ciddi biçimde yükseltir.
                </p>

                <h2 id="sahne-tasarim">4. 2026 Sahne Tasarımında LED ile Neler Değişiyor?</h2>
                <p>
                  LED ekran artık yalnızca arka fon değil; sahnenin tamamını saran bir deneyim alanı. Yan ekranlar, totemler ve sahne mimarisiyle birleşen ekran kurguları öne çıkıyor.
                </p>

                <h2 id="fiyatlar">2026’da LED Ekran Kiralama Fiyatlarını Ne Belirler?</h2>
                <p>
                  LED ekran kiralama fiyatı tek bir “m²” hesabı değildir. Piksel aralığı, panel tipi, yenileme oranı, kurulum süresi ve yedek panel stoğu gibi değişkenler toplam maliyeti belirler.
                </p>
                <p>
                ...
                <div className="not-prose bg-gray-50 border border-gray-200 rounded-xl p-6 my-8 space-y-4">
                  <ul className="list-disc list-inside text-sm text-gray-700 space-y-2">
                    ...
                    <li>Kurulum süresi, teknik ekip sayısı, yedek panel</li>
